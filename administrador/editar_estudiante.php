...
$id_est = $_GET['id'];
$busc_est = "SELECT * FROM estudiante WHERE id='$id_est'";
$ejec_busc_est = mysqli_query($conexion, $busc_est); 
$res_busc_est=mysqli_fetch_array($ejec_busc_est);
$id_carrera = $res_busc_est['id_carrera'];
$id_semestre = $res_busc_est['id_semestre'];
$id_obr = $res_busc_est['id_observacion'];
?>
<!DOCTYPE html>
<html lang="es">
  <head>
    ...
    <title>Estudiante<?php include ("../include/header_title.php"); ?></title>
    <!--icono en el titulo-->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="">
                    <h2 align="center">Editar Estudiante</h2>
                    ...
                    <form role="form" action="operaciones/actualizar_estudiante.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="ud" required="" value="<?php echo $res_busc_ud['unidad_didactica']; ?>"  style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" id="modulo" name="modulo" value="<?php echo $res_busc_ud['id_modulo']; ?>" required="required">
                            <?php
                            $busc_modu = "SELECT * FROM modulo_formativo WHERE id_carrera_profesional='$id_carrera'";
                            $ejec_busc_modu = mysqli_query($conexion, $busc_modu);
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="curricular" required="" maxlength="1" value="<?php echo $res_busc_ud['curricular']; ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          <br>
                          <br>
                        </div>
                      </div>
