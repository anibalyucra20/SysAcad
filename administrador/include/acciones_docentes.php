                    ...
                    <form role="form" action="operaciones/actualizar_docente.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" name="dni" required="" maxlength="8" value="<?php echo $res_busc_doc['dni']; ?>">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="ap_nom" required="" value="<?php echo $res_busc_doc['apellidos_nombre']; ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="cond_laboral" value="" required="required">
                            <option></option>
                            <option value="CONTRATADO" <?php if ("CONTRATADO"==$res_busc_doc['cond_laboral']): 
                            echo 'selected="selected"';
                             endif ?>>CONTRATADO</option>
                            <option value="NOMBRADO" <?php if ("NOMBRADO"==$res_busc_doc['cond_laboral']): 
                            echo 'selected="selected"';
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="date" class="form-control" name="fecha_nac" required="" value="<?php echo $res_busc_doc['fecha_nac']; ?>">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="niv_form" required="" value="<?php echo $res_busc_doc['nivel_educacion']; ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="seg_espec" value="" required="required">
                            <option></option>
                            <option value="SI" <?php if ("SI"==$res_busc_doc['2da_especialidad']): 
                            echo 'selected="selected"';
                             endif ?>>SI</option>
                            <option value="NO" <?php if ("NO"==$res_busc_doc['2da_especialidad']): 
                            echo 'selected="selected"';
                             endif ?>>NO</option>
                          </select>
                          <br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" name="telefono" required="" maxlength="15" value="<?php echo $res_busc_doc['telefono']; ?>">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
