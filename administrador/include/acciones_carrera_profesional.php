 ...
 <!--MODAL EDITAR-->
  <div class="modal fade edit_<?php echo $res_busc_carrera['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                  ...
                  <div class="x_content">
                    <br />
                    <form role="form" action="operaciones/actualizar_carrera_profesional.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="tipo" value="<?php echo $res_busc_carrera['tipo']; ?>" required="required">
                              <option></option>
                              <option value="Módulo Profesional" <?php if("Módulo Profesional" == $res_busc_carrera['tipo']){
                                echo 'selected=""';
                              };?>>Módulo Profesional</option>
                              <option value="Módulo Transversal" <?php if("Módulo Transversal" == $res_busc_carrera['tipo']){
                                echo 'selected=""';
                              };?>>Módulo Transversal</option>
                          </select>
                          <br>
                        </div>
                      </div>
